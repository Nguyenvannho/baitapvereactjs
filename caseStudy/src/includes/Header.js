        ...
        <>
            ...
            <div className="container-fluid">
                <div className="row border-top px-xl-5">
                    <div className="col-lg-3 d-none d-lg-block">
                        <nav
                            className="position-absolute navbar navbar-vertical navbar-light align-items-start p-0 border border-top-0 border-bottom-0 bg-light collapse"
                            id="navbar-vertical"
                        ...
                        <nav className="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                            ...
                            >
                                <div className="navbar-nav mr-auto py-0">
                                    ...
                                    <a href="/ProductDetails/1" className="nav-item nav-link">
                                        Shop Detail
                                    </a>
